    ...
    <div class="container px-5 pt-12 pb-24 mx-auto">
      <div class="container px-5 py-24 mx-auto flex justify-center ">
        <div class="lg:w-1/3 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col w-full mt-10 md:mt-0 relative z-10 shadow-md">
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900 tracking">Login</h1>
          ...
          <p class="text-xs text-gray-500 mt-3">Don't have an account?. <NuxtLink to="/signup"><b><u>Sign up</u></b></NuxtLink> here.</p>
