    ...
    <div class="container px-5 pt-12 pb-24 mx-auto">
      <div class="container px-5 py-24 mx-auto flex justify-center ">
        <div class="lg:w-1/3 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col w-full mt-10 md:mt-0 relative z-10 shadow-md">
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900 tracking">Sign Up</h1>
          ...
          <div class="relative mb-4">
            <label for="password" class="leading-7 text-sm text-gray-600">Choose Password</label>
          ...
          <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign up</button>
          <p class="text-xs text-gray-500 mt-3">Already have an account?. <NuxtLink to="/login"><b><u>Log in</u></b></NuxtLink> here.</p>
